    ...
    <div class="all">
        <form method="POST">
            ...
            <div class="center">
                ...
                <div class="tenlp2">TRANG CHỦ/ CUỘC CHIẾN VÔ CỰC
                </div>
                <div class="baoanh2">
                    <div class="imgxp" >
                        <img src="img/cuocchienvocuc.jpg" alt="" width="130px" height="150px">
                    </div>
                    <b>XEM PHIM CUỘC CHIẾN VÔ CỰC</b> 
                    ...
                    <iframe width="670px" height="380px" style="padding-left: 10px;" src="https://www.youtube.com/embed/EklC3ukNuqw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
